    ...
    <div className="min-h-screen bg-[var(--wt-bg)] flex flex-col items-center justify-center text-center px-5 md:px-[52px] pt-[100px] pb-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[var(--wt-bg)] via-transparent to-[var(--wt-bg)]" />
      </div>
      ...
      {/* Logo */}
      <div className="mb-9 animate-[fadeIn_0.9s_ease_0.2s_both] relative z-10">
        <Image
          src="/logo.png"
      ...
      {/* Eyebrow */}
      <div className="text-[9px] tracking-[5px] text-[var(--wt-gold)] uppercase mb-5 animate-[riseUp_0.8s_ease_0.65s_both] font-light relative z-10">
        Headquartered in the UAE &nbsp;&middot;&nbsp; Global Medical
        Federation &nbsp;&middot;&nbsp; Est. 2025
      </div>

      {/* H1 */}
      <h1 className="font-heading text-[50px] md:text-[78px] font-light text-white leading-[0.94] mb-2 animate-[riseUp_0.8s_ease_0.8s_both] relative z-10">
        Regenerative
        <br />
        Medicine
        <br />
      ...
      {/* Subtitle */}
      <div className="font-heading text-[22px] font-light text-[rgba(255,255,255,0.28)] italic mb-7 animate-[riseUp_0.8s_ease_0.9s_both] relative z-10">
        Where Science Becomes Practice.
      </div>

      {/* Separator */}
      <div className="flex items-center gap-3.5 justify-center mb-7 animate-[fadeIn_0.8s_ease_1s_both] relative z-10">
      ...
      {/* Explainer block */}
      <div className="max-w-[680px] mx-auto mb-5 animate-[riseUp_0.8s_ease_1s_both] relative z-10">
      ...
      {/* Chips */}
      <div className="flex gap-2.5 justify-center flex-wrap mx-auto my-[22px] mb-11 animate-[riseUp_0.8s_ease_1.05s_both] relative z-10">
        {chips.map((chip) => (
          <div
            key={chip}
      ...
      {/* CTA button */}
      <div className="flex gap-3.5 justify-center animate-[riseUp_0.8s_ease_1.15s_both] relative z-10">
        <Link
          href="#register"
